...
export class ClaudeAcpAgent implements Agent {
  ...
  private async createSession(
    ...
    // Resolve agent name from env var or _meta.agent sent via ACP protocol.
    const resolvedAgentName: string | undefined =
      process.env.CLAUDE_AGENT_ACP_AGENT_NAME ??
      (params._meta?.agent as string | undefined);
